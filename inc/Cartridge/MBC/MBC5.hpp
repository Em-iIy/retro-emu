...
#define ROM_BANK_LOWER_NUMBER_START	0x2000
#define ROM_BANK_LOWER_NUMBER_END	0x2FFF

#define ROM_BANK_UPPER_NUMBER_START	0x2000
#define ROM_BANK_UPPER_NUMBER_END	0x3FFF
...
{
	public:
		MBC5(uint16_t romBankCount, uint16_t ramBankCount);
		~MBC5();
