...
void		CPU::initExtendedInstructionTable()
{
	...
	setCallback(extendedTable, OpCodesExt::RLC_B, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RLC_C, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RLC_D, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RLC_E, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RLC_H, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RLC_L, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RLC_HL, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RLC_A, std::bind(&CPU::notImplemented, this));

	setCallback(extendedTable, OpCodesExt::RRC_B, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RRC_C, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RRC_D, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RRC_E, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RRC_H, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RRC_L, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RRC_HL, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RRC_A, std::bind(&CPU::notImplemented, this));

	setCallback(extendedTable, OpCodesExt::RL_B, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RL_C, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RL_D, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RL_E, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RL_H, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RL_L, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RL_HL, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RL_A, std::bind(&CPU::notImplemented, this));

	setCallback(extendedTable, OpCodesExt::RR_B, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RR_C, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RR_D, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RR_E, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RR_H, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RR_L, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RR_HL, std::bind(&CPU::notImplemented, this));
	setCallback(extendedTable, OpCodesExt::RR_A, std::bind(&CPU::notImplemented, this));
