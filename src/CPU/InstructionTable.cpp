...
void		CPU::initInstructionTable()
{
	...
	// setCallback(table, OpCodes::CALL_NZ_a16, std::bind(&CPU::notImplemented, this));
	// setCallback(table, OpCodes::PUSH_BC, std::bind(&CPU::notImplemented, this));
	...
	// setCallback(table, OpCodes::RET_Z, std::bind(&CPU::notImplemented, this));
	// setCallback(table, OpCodes::RET, std::bind(&CPU::notImplemented, this));
	// setCallback(table, OpCodes::JP_Z_a16, std::bind(&CPU::notImplemented, this));
	// setCallback(table, OpCodes::EXTENDED, std::bind(&CPU::notImplemented, this));
	// setCallback(table, OpCodes::CALL_Z_a16, std::bind(&CPU::notImplemented, this));
	// setCallback(table, OpCodes::CALL_a16, std::bind(&CPU::notImplemented, this));
	...
	// setCallback(table, OpCodes::CALL_NC_a16, std::bind(&CPU::notImplemented, this));
	// setCallback(table, OpCodes::PUSH_DE, std::bind(&CPU::notImplemented, this));
	...
	// setCallback(table, OpCodes::RET_C, std::bind(&CPU::notImplemented, this));
	// setCallback(table, OpCodes::RETI, std::bind(&CPU::notImplemented, this));
	// setCallback(table, OpCodes::JP_C_a16, std::bind(&CPU::notImplemented, this));
	// setCallback(table, OpCodes::CALL_C_a16, std::bind(&CPU::notImplemented, this));
	...
	// setCallback(table, OpCodes::PUSH_HL, std::bind(&CPU::notImplemented, this));
	...
	// setCallback(table, OpCodes::JP_HL, std::bind(&CPU::notImplemented, this));
	...
	// setCallback(table, OpCodes::PUSH_AF, std::bind(&CPU::notImplemented, this));
	// setCallback(table, OpCodes::OR_d8, std::bind(&CPU::notImplemented, this));
